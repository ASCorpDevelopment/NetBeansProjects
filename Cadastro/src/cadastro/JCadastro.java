...
public class JCadastro extends javax.swing.JFrame {
    ...
    private void blCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_blCadastrarActionPerformed
        ...
        cadastro.add(txtNome.getText());
        cadastro.add(txtAnoNascimento.getText());
        cadastro.add(txtAltura.getText());
        cadastro.add(txtEstadoCivil.getText());
        for(int i=0;i<cadastro.size(); i++){
            lista.addElement(cadastro.get(i));
        }
